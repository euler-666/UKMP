...
#  - Added support for weight recalling after pruning.
...
PEFT_TYPE_TO_MODEL_MAPPING = {
    ...
    PeftType.PRUNELORA: PruneLoraModel,
}
        ...
        for adapter_name in selected_adapters:
            ...
            if is_main_process and safe_serialization:
                ...
                if output_name is not None:
                    safe_save_file(
                        output_state_dict,
                        os.path.join(output_dir, SAFETENSORS_WEIGHTS_NAME.replace('adapter_model', output_name)),
                        metadata={"format": "pt"},
                    )
                else:
                    safe_save_file(
                ...
                if output_name is not None:
                    torch.save(output_state_dict, os.path.join(output_dir, WEIGHTS_NAME.replace('adapter_model', output_name)))
                else:
...
class PeftModelForPrefixDerivative(PeftModel):
    """
    Peft model for causal language modeling.
