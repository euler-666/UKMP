...
eval_ft_cmd = (
    ...
    f" --eval_mode generation"
    f" --max_eval_samples {EVAL_MAX_SAMPLES}"
    f" --job_id eval_finetuned_ocr"
    f" --output_dir eval_results/finetuned_ocr"
)
...
print(f"  Pruned eval:      eval_results/pruned_ocr/")
print(f"  Fine-tuned eval:  eval_results/finetuned_ocr/")
print(f"{'='*70}\n")
