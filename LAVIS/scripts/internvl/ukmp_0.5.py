"""
End-to-end UKMP pipeline for InternVL 3.5 1B at 50% pruning ratio.
...
program = (
    ...
    f" --output_dir eval_results/pruned"
)
subprocess.call(program, shell=True)
...
program = (
    ...
    f" --eval_mode vqa"
    f" --job_id {eval_job_id}"
    f" --output_dir eval_results/finetuned"
)
subprocess.call(program, shell=True)

print("[DONE] - Full UKMP pipeline for InternVL complete")
